...
__all__ = [
    "TrainImageDataset", "TestImageDataset",
    "PrefetchGenerator", "PrefetchDataLoader", "CPUPrefetcher", "CUDAPrefetcher",
]


class TrainImageDataset(Dataset):
    """Define train dataset loading methods.

    Args:
        train_gt_image_dir (str): Train ground-truth dataset address.
        train_gt_image_size (int): Train ground-truth resolution image size.
    ...
    def __init__(
            self,
            train_gt_image_dir: str,
            train_gt_image_size: int,
            upscale_factor: int,
    ) -> None:
        super(TrainImageDataset, self).__init__()
        self.image_file_names = [os.path.join(train_gt_image_dir, image_file_name) for image_file_name in
                                 os.listdir(train_gt_image_dir)]
        self.train_gt_image_size = train_gt_image_size
    ...
    def __getitem__(self, batch_index: int) -> [dict[str, Tensor], dict[str, Tensor]]:
        ...
        gt_crop_image = imgproc.random_crop(gt_image, self.train_gt_image_size)
