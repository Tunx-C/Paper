...
def _blockproc_torch(x, kernel: int or tuple or list, fun, border_size=None, pad_partial=False, pad_method='zero'):
    ...
    Args:
        ...
        func: function to process each block
...
def _get_mscn_feature_torch(tensor: torch.Tensor) -> Tensor:
